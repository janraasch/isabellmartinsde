...
Ein **Erstgespräch** beinhaltet ein **Gespräch** (45 Minuten, per Telefon oder Video) mit Anamnese und Besprechung von ersten Empfehlungen und Anpassungen in der Fütterung. Zusätzlich erhältst du die individuell besprochenen Empfehlungen und Anpassungen schriftlich als **Dokument**. Außerdem kontrolliere ich einmal grob die **Nährstoffabdeckung** des Futters deines Hundes. Das Erstgespräch kostet **120 Euro**. 

Manchmal reicht das Erstgespräch schon aus, wenn dein Anliegen nicht so umfangreich ist. Danach können wir ein **Folgegespräch** (30 Min., 60 Euro) vereinbaren oder für eine längere Betreuung biete ich dir gerne eine Auswahl an **Paketen** an, worunter du wählen kannst.
